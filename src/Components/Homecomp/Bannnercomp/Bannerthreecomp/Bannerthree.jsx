      ...
      <div className='mainContainer'>
        <div ref={bannerRef} className="Bannerthree-container">
          <div className="Bannerthree-left">
            ...
            <h3>Planogram compliance boosts retail profits by 8.1%, but poor adherence leads to sales losses of $1M to $30M annually per retailer. (Sources: Shopper Technology Institute, National Association of Retail Marketing)</h3>
